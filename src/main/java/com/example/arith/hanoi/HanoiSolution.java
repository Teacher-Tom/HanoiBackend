...
public class HanoiSolution {
    ...
    public HanoiSolution(int NumOfTower, int NumOfDisk){
        ...
        result = new HanoiResult(NumOfTower,NumOfDisk);
        ...
        result.setLeastMove(bestSolution.LeastMove());
    ...
    public void recordCurrentStatus(){
        HanoiStep hanoiStep = new HanoiStep(TotalStep, TotalPeg,NumberOfTower);
